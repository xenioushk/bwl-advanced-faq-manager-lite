...
function add_baf_shortcode_plugin($plugin_array)
{
  ...
  $plugin_array['baf'] = plugins_url(BWL_BAFM_PLUGIN_ROOT . '/libs/tinymce/scripts/baf_tinymce_button.js');
  return $plugin_array;
}
...
?>
  ...
  <div id="baf_editor_popup_content">
    ...
    <div class="row bafm_dn" id="faq_item_container">
      ...
      <strong><a href="' . BWL_BAF_CC_URL . '" target="_blank">
          Upgrade to pro version to unlock the feature.
        </a></strong>
    ...
    <div class="row baf_sc_settings">
      ...
      <input type="text" id="no_of_faqs" name="no_of_faqs" value="" class="baf_input_small" />
      <small><?php _e('e.g: Any number like 1,2,3 ', 'bwl-adv-faq'); ?></small>
    </div>
    ...
    <div class="row baf_sc_settings">
      ...
      <strong><a href="' . BWL_BAF_CC_URL . '" target="_blank">
          Upgrade to pro version to unlock all the features.
        </a></strong>
    ...
    <p style="text-align: center;font-weight:bold;"><a href="https://xenioushk.github.io/docs-wp-plugins/baf/index.html#plugin_shortcodes_section" target="_blank">Discover All Shortcode Features</a></p>
