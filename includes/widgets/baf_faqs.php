...
<p>
  <label
    for="<?php echo $this->get_field_id('bwl_advanced_faq_manager_shortcode') ?>"><?php esc_html_e('FAQ Shortcode', 'bwl-adv-faq'); ?></label>
  <textarea id="<?php echo $this->get_field_id('bwl_advanced_faq_manager_shortcode') ?>"
    name="<?php echo $this->get_field_name('bwl_advanced_faq_manager_shortcode') ?>" cols="30" rows="3"
    class="widefat"><?php echo esc_attr($bwl_advanced_faq_manager_shortcode) ?></textarea>
...
<div class="baf-sc-hints">
  <ol>
    <li>
      <p>Display Random FAQ:</p>
      <small>[bwla_faq orderby='rand' /]</small>
    </li>
    <li>
      <p>Display Top Voted FAQs:</p>
