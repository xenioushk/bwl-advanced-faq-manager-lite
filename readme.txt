...
Create a helpful and functional FAQ page within 5 minutes with the BWL Advanced FAQ Manager plugin. The advanced FAQ manager plugin comes with almost zero configuration requirements. Just upload and install the plugin, and you are ready to go.

The plugin has a built-in Shortcode generator integrated with the TinyMCE editor and works with the Gutenberg editor. Insert shortcodes quickly and display FAQ items inside any page, post, or widget area.
...
3. Submit Likes For The FAQ Content
...
You can also add limit, order, and orderby parameters in topics and categories.
