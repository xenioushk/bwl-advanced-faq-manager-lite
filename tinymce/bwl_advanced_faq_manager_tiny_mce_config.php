...
function add_baf_shortcode_plugin( $plugin_array ) {
    $plugin_array['baf'] = plugins_url( BWL_BAFM_PLUGIN_ROOT . 'libs/tinymce/baf_tinymce_button.js' );
    return $plugin_array;
}
...
<div id="baf_editor_popup_content">
    ...
    <input type="text" id="no_of_faqs" name="no_of_faqs" value="" style="width: 50px;" />
